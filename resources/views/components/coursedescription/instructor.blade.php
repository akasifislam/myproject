        ...
        <div class="course-instructor">
            <div class="course-instructor-info">
                <div class="instructor-image">
                    <img src="{{ asset($courseDetails->instructor->image) }}" alt="Instructor" />
                </div>
                <div class="instructor-text">
                    <h6><a href="{{ route('instructor.profile', $courseDetails->instructor->slug) }}">
                            {{ $courseDetails->instructor->firstname . ' ' . $courseDetails->instructor->lastname }}</a>
                    </h6>
                    <p>{{ $courseDetails->instructor->profession }}</p>
                    <div class="d-flex align-items-center instructor-text-bottom">
                        ...
                        <div class="d-flex align-items-center ratings-icon">
                            ...
                            <p>{{ $instructorTotalCourses }} Courses</p>
                        </div>
                    </div>
                </div>
            </div>

            <p class="course-instructor-description mt-3">
