<div>
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('instructor.course.chapter.update', $chapter->id) }}" method="POST">
                @csrf
                @method('Put')
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('instructor.course.syllabus', $chapter->course_id) }}" class="btn btn-danger">
