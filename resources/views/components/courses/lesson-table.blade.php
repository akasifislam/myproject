                            ...
                            @forelse ($lessons as $lesson)
                                @if ($lesson->chapter_id == $chapter->id)
                                    <tr data-id="{{ $chapter->id }}">
                                        ...
                                        <td width="25%">
                                            <a href="{{ route('chapter.lesson.edit', $lesson->id) }}"
                                                title="Edit Lesson" class="btn bg-info"><i class="fas fa-edit"></i></a>
                                            <form action="{{ route('chapter.lesson.delete', $lesson->id) }}"
