<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('chapter.lesson.update', $lesson->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input name="duration" type="text" class="form-control @error('duration') is-invalid @enderror"
                    id="duration" placeholder="Total minutes" value="{{ $lesson->duration }}">
                @error('duration') <span class="invalid-feedback"
                    role="alert"><strong>{{ $message }}</strong></span> @enderror
            </div>
            <div class="form-group">
                <label for="update_lessonType">Lesson Type</label>
            ...
            <div class="form-group" id="update_video_url_group">
                <label for="update_video_url">Video URL</label>
            ...
            <div class="form-group">
                ...
                <a href="{{ route('course.syllabus', $lesson->course_id) }}" class="btn btn-danger">
