...
<head>
    ...
    <title>Course Description-Education</title>
            ...
            <div class="coursedescription-header">
                <div class="coursedescription-header-start">
                    <div class="logo-image">
                        <a href="{{ route('index') }}"><img src="{{ asset('frontend') }}/dist/images/logo/logo.png"
                                alt="Logo" /></a>
                    </div>
            ...
            <div class="col-lg-8">
                <div class="course-description-start">
                    ...
                    <div class="course-description-start-content">
                        @if ($selected_lesson)
                            <h4 id="lesson_name">{{ $selected_lesson->lesson_name }}</h4>
                        @else
                            <h4 id="lesson_name">{{ $course->title }}</h4>
                        @endif
                        ...
                        <div class="tab-content course-description-start-content-tabitem" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-linstruc" role="tabpanel"
                                ...
                                <x-coursedescription.instructor-details :course="$course"
