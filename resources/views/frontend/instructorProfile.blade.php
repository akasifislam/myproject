...
@section('title') Instructor Profile - {{ env('APP_NAME') }} @endsection
                ...
                <div class="col-lg-4">
                    <div class="instructor-courses-instructor">
                        <div class="instructor-image mx-auto text-center">
                            <img src="{{ asset($instructor->image) }}" alt="Instructor" />
                        </div>
                        <div class="instructor-info text-center">
                            <h5 class="font-title--sm">{{ $instructor->firstname . ' ' . $instructor->lastname }}</h5>
                            <p class="text-secondary mb-3">{{ $instructor->profession }}</p>


                            <ul class="list-inline social-links">
                                @if ($instructor->instagram_link)
                                    <li class="list-inline-item">
                                        <a target="_blank" href="{{ $instructor->instagram_link }}">
                                ...
                                @if ($instructor->linkedin_link)
                                    <li class="list-inline-item">
                                        <a target="_blank" href="{{ $instructor->linkedin_link }}">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                @if ($instructor->twitter_link)
                                    <li class="list-inline-item">
                                        <a target="_blank" href="{{ $instructor->twitter_link }}">
                                ...
                                @endif
                                @if ($instructor->youtube_link)
                                    <li class="list-inline-item">
                                        <a target="_blank" href="{{ $instructor->youtube_link }}">
                                ...
                                @endif
                                @if ($instructor->fb_link)
                                    <li class="list-inline-item">
                                        <a target="_blank" href="{{ $instructor->fb_link }}">
                        ...
                        <div class="instructor-course-info">
                            ...
                            <div class="instructor-course-info-students">
                                ...
                                <div class="text text-center">
                                    <h6>{{ $instructor->total_enrolled }}</h6>
                            ...
                            <div class="instructor-course-info-courses">
                                ...
                                <div class="text text-center">
                                    @if ($instructor->course->count() > 1)
                                        <h6>{{ $instructor->course->count() }}</h6>
                                        <p>Courses</p>
                                    @else
                                        <h6>{{ $instructor->course->count() }}</h6>
                        ...
                        @if ($instructor->education->count())
                            <div class="instructor-qualification">
                                <h6>Education</h6>
                                @foreach ($instructor->education as $education)
                                    @if ($loop->last)
                        ...
                        @endif
                        @if ($instructor->experience->count())
                            <div class="instructor-qualification mb-0 pb-0 border-0">
                                <h6>Experiences</h6>
                                @foreach ($instructor->experience as $experience)
                                    @if ($loop->last)
                                        <div class="qualification-info pb-0 mb-0 border-0">
                                            <div class="qualification-info-title">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="instructor-rating-area d-flex">
                                            <div class="rating-number">
                                                ...
                                                <p>Instructor Course Rating</p>
                                            </div>
                                            {{-- rating range --}}
                                            {{-- <x-rating.chapter-table :chapters="$chapters" /> --}}
                                            <x-rating.rating-range :starsCounts="$starsCounts"
                                                :starsPercentages="$starsPercentages" />
                                        </div>
                                        <div class="students-feedback">
                                            ...
                                            <div class="text-center">
                                                <button id="load_more_button"
                                                    class="button button-md button--primary-outline" type="button">Load
                                                    more</button>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    function formatRatingItem(item) {
        var review = `<div class="students-feedback-item">
    ...
    function loadMoreData(url) {
        axios.post(url, {
            ...
            .then(res => {
                ...
                // handle button
                if (nextPageUrl == null) {
                    $('#load_more_button').attr('disabled', true).removeAttr('class').attr('class',
                        'button button-md button--disabled').html('No more results found!');
                } else {
    ...
    loadMoreData('{{ route('instructor-comment-data-load') }}');
