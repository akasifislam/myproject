...
@section('title') Register as Instructor @endsection
@section('footer_attribute') style="margin-top:50px" @stop
@section('content')
            ...
            <div class="row align-items-center justify-content-md-center">
                <div class="col-lg-5  order-2 order-lg-0">
                    <div class="signup-area-textwrapper">
                        ...
                        <h2 class="font-title--md mb-0">Register As An Instructor</h2>
                        <p class="mt-2 mb-lg-4 mb-3">Already have account? <a href="{{ route('instructor.login') }}" class="text-black-50">Sign In</a></p>

                        <form action="{{ route('becomeinstructor.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-element d-flex align-items-center">
                                <input class="checkbox-primary me-1" type="checkbox" name="privacy" id="agree" required  />
                                <label for="agree" class="text-secondary mb-0 fs-6 fw-normal">Accept the Terms and Privacy  Policy</label>

                            </div>
                            <span class="text-danger">
                                @if ($errors->has('privacy'))
                                {{ $errors->first('privacy') }} @enderror
                            </span>
