...
@section('title') Contact - {{ env('APP_NAME') }} @endsection
        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb pb-0 mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('contact') }}"
                            class="fs-6 text-secondary">Contact</a></li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="hero__content-info">
                        ...
                        <ul class="hero__content-location d-flex align-items-center">
                            <li>
                                <span>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6">
                                ...
                                <input name="name" type="text"
                                    class="form-control form-control--focused @error('name') is-invalid @enderror"
                                    placeholder="Type here..." id="name" required>
                                @error('name') <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-6">
                                <label for="email">Email</label>
                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    placeholder="Type here..." id="email" required>
                        ...
                        <div class="row my-lg-2 my-2">
                            <div class="col-12">
                                ...
                                <input name="subject" type="text" id="subject"
                                    class="form-control @error('subject') is-invalid @enderror" placeholder="Type here..." required>
                                @error('subject') <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                @error('message') <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
