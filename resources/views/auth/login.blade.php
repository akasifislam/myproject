            ...
            <div class="row align-items-center">
                <div class="col-xl-5 order-2 order-xl-0">
                    <div class="signup-area-textwrapper">
                        ...
                        <p class="mt-2 mb-lg-4 mb-3">Already have account? <a href="{{ route('student.register') }}"
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-element @error('email') error @enderror">
                                ...
                                <div class="@error('email') form-alert-input @enderror">
                                    <input value="{{ old('email') }}" type="email" placeholder="Enter Email" id="email" name="email" required />
                                    @if ($errors->has('email'))
                            ...
                            <div class="form-element @error('password') error @enderror">
                                <div class="d-flex justify-content-between @error('password') form-alert @enderror">
                                    <label for="confirm-password">Password</label>
                                    @error('password')<span>{{ $message }}</span>@enderror
                                </div>

                                <div class="@error('password') form-alert-input @enderror">
                                    <input type="password" placeholder="Enter Password" id="confirm-password"
                            ...
                            <div style="text-align: right;margin-top:-5px">
                                <a href="{{ route('password.request') }}"
                                    class="text-primary fs-6 fw-normal text-right mb-2">Forget
                                    Password</a>
                            </div>
