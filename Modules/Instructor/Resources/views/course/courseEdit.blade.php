        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <form class="form-horizontal" action="{{ route('instructor.course.update', $course->slug) }}"
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row" id="coursetype">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Price</label>
                                            <input id="price" value="{{ $course->price }}" name="price" type="text"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Video Duration (Minutes) <span class="text-danger">*</span></label>
