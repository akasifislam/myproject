            ...
            <div class="col-md-2">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">Instructor Activity</h3>
                    </div>
                    <div class="card-body">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link {{ Route::is('instructor.activity') || Route::is('instructor.education.edit') ? 'active' : '' }}" href="{{ route('instructor.activity', $instructor->id) }}"> Education </a>
