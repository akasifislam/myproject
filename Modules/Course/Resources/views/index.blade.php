...
@section('title') Course List | Admin @endsection
@section('content')
                                        ...
                                        <thead>
                                            <tr role="row" class="text-center">
                                                ...
                                                <th class="sorting_desc" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Rendering engine: activate to sort column ascending"
                                                    aria-sort="descending" width="10%">Instructor</th>
                                                <th class="sorting_desc" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Rendering engine: activate to sort column ascending"
                                        ...
                                        <tbody>
                                            @foreach ($courses as $course)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="sorting_1 text-center" tabindex="0">
                                                        {{ $course->discount_price ? $course->discount_price : '-' }}</td>
                                                    <td class="sorting_1 text-center" tabindex="0">
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" x-placement="bottom-start"
                                                                ...
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('module.course.course.pdf', $course->id) }}"><i
                                                                            class="fas fa-file-pdf text-danger"></i>&nbsp;&nbsp;Download
                                                                        PDF</a></li>
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('module.course.show', $course->slug) }}"><i
                                                                            class="fas fa-eye text-success"></i>&nbsp;&nbsp;Course
                                                                        Details</a></li>
                                                                <li><a target="_blank" class="dropdown-item"
                                                                        href="{{ route('course.details', $course->slug) }}"><i
                                                                            class="fas fa-link text-warning"></i>&nbsp;&nbsp;Course
                                                                        Link</a></li>
                                                                <li><a href="{{ route('course.syllabus', $course->id) }}"
                                                                        class="dropdown-item"><i
                                                                            class="fas fa-book-open text-primary"></i>&nbsp;&nbsp;Chapter
                                                                        and Lesson</a></li>
                                                                <li><a href="{{ route('module.course.edit', $course->slug) }}"
                                                                        class="dropdown-item"><i
                                                                            class="fas fa-edit text-info"></i>&nbsp;&nbsp;Edit
                                                                        Course</a></li>
                                                                <li>
                                                                    <form
                                                                        action="{{ route('module.course.destroy', $course->slug) }}"
    ...
    <script>
        ...
        $('.toggle-switch').change(function() {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '{{ route('module.course.status.change') }}',
                data: {
                    'status': status,
                    'id': id
                },
