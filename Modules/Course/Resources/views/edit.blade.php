...
@section('title') Course Edit | Admin @endsection
...
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">Edit Course</h3>
                        <a href="{{ route('module.course.index') }}"
                            class="btn bg-primary float-right d-flex align-items-center justify-content-center"><i
                                class="fas fa-arrow-left"></i>&nbsp;Back</a>
                    </div>
                    <form class="form-horizontal" action="{{ route('module.course.update', $course->slug) }}"
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $course->title }}" name="title" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-inline">
                                                    <input onclick="courseType('paid')" type="radio" id="paidcourse"
                                                        name="course_type" value="Paid"
                                                        {{ $course->course_type == 'Paid' ? 'checked' : '' }}>
                                                ...
                                                <div class="icheck-success d-inline ml-3">
                                                    <input onclick="courseType('free')" type="radio" id="freecourse"
                                                        ...
                                                        {{ $course->course_type == 'Free' ? 'checked' : '' }}>
                                ...
                                <div class="row" id="coursetype">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Price</label>
                                            <input id="price" value="{{ $course->price }}" name="price" type="number"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input id="discount_price" value="{{ $course->discount_price }}"
                                                name="discount_price" type="number" class="form-control "
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="level" class="form-control @error('level') is-invalid @enderror">
                                                <option {{ $course->level == 'Beginner' ? 'selected' : '' }}
                                                    value="Beginner">Beginner</option>
                                                <option {{ $course->level == 'Intermediate' ? 'selected' : '' }}
                                                    value="Intermediate">Intermediate</option>
                                                <option {{ $course->level == 'Advanced' ? 'selected' : '' }}
                                                    value="Advanced">Advanced</option>
                                                <option {{ $course->level == 'Expert' ? 'selected' : '' }}
                                                    value="Expert">
                                                    Expert</option>
                                            </select>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $course->duration }}" name="duration" type="number"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="video_type"
                                                ...
                                                <option {{ $course->level == 'youtube' ? 'selected' : '' }}
                                                    value="youtube">Youtube</option>
                                                <option {{ $course->level == 'vimeo' ? 'selected' : '' }} value="vimeo">
                                                    Vimeo</option>
                                            </select>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $course->video_url }}" name="video_url" type="url"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor2" type="text" class="form-control" name="description"
                                                placeholder="Write description of course... ">{{ $course->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6 offset-3 text-center">
                                        <button type="submit" class="btn btn-success">
                                            <i class="fas fa-sync"></i> Update Course
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <input id="courseValue" type="hidden" value="{{ $course->course_type }}">
@endsection
