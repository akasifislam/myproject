...
@section('title') Enroll New | Admin @endsection
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('module.course.enroll.index') }}"
                            class="btn bg-primary float-right d-flex align-items-center justify-content-center"><i
                                class="fas fa-arrow-left"></i>&nbsp;Back</a>
                    </div>
                    <div class="card-body">
                        <form class="w-50 mx-auto my-5" action="{{ route('module.course.enroll.store') }}" method="POST">
                            @csrf
